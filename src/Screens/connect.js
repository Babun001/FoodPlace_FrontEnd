...
import AppImage from '../ImagesAndIcons/vegetable.jpeg';
import './screen.css';

export default function connect() {
    return (
        <>
            <div className="container d-flex bg-dark col-xxl-8 px-4 py-5 " style={{ height: "100vh", justifyContent:'center'}}>
                <div className=" row flex-lg-row-reverse align-items-center g-5 py-5 mx-5">
                    <div id='sampleImage' className="col-sm-10 col-lg-6">
                        <img src={AppImage} className="d-block mx-lg-auto img-fluid" alt="sampleImage" width="700" height="500" style={{ borderRadius: "20px" }} />
                    </div>
                    <div className="container col-lg-6 mx-auto">
                        ...
                        <div className='connectionLink'>
                            <Link className='s_link' to='https://www.facebook.com/babun.roy.1428'>
                            ...
                            <Link className='s_link' to='https://www.instagram.com/babunroymukherjee/'>
                            ...
                            <Link className='s_link' to='https://www.linkedin.com/in/babun-roy-980139273/'>
                            ...
                            <Link className='s_link' to='https://github.com/Babun001'>
                        ...
                        <div className='text-white mt-5 '>
                            <h2>Contact Info.</h2>
                            <p className='mt-1 blockquote-footer'>Feel free to reach out via email:</p>
                            <p className='text-white'><strong>Email:</strong> bunnyroymukherjee007@yahoo.com</p>
                        </div>
